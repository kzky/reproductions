...
screen -Sdm "adam-46" bash -c "python train.py -d 2 -b 64 --solver Adam --lr 1e-4 --monitor-path result/example_46 --decay-rate 0 --share-type within-pyramid --S 2 --R 1 --D 16"  # decov -> convscreen -Sdm
