...
# Use sum
screen -Sdm "adam-85" bash -c "python train.py -d 0 -b 64 --solver Momentum --lr 5e-6 --monitor-path result/example_85 --share-type across-pyramid --S 2 --img-paths /home/kzky/nnabla_data/BSDS200 /home/kzky/nnabla_data/T91"
...
screen -Sdm "adam-94" bash -c "python train.py -d 3 -b 64 --solver Adam --lr 1e-4 --monitor-path result/example_94 --share-type within-pyramid --S 2 --img-paths /home/kzky/nnabla_data/BSDS200 /home/kzky/nnabla_data/T91 --imresize-mode matlab"
